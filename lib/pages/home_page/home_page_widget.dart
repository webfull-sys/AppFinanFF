...
import '/components/adicionar_registro/adicionar_registro_widget.dart';
import '/components/editar_registro/editar_registro_widget.dart';
import '/components/lista_produtos/lista_produtos_widget.dart';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          backgroundColor: Color(0xFF024B16),
          elevation: 8.0,
          child: Icon(
            Icons.add,
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Image.asset(
                                        Theme.of(context).brightness ==
                                                Brightness.dark
                                            ? 'assets/images/logowebfullinteiradeitadaneve.png'
                                            : 'assets/images/logowebfullinteiradetadacinza.png',
                                        width:
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          _model.apiResultl5f =
                                              await CancelarAssinaturaCall.call(
                                            id: telaCompletaUsuariosRow?.assId,
                                          );
                                          ...
                                          var confirmDialogResponse =
                                              await showDialog<bool>(
                                                  ...
                                                  false;
                                          if ((_model.apiResultl5f?.succeeded ??
                                              true)) {
                                            await showDialog(
                                              context: context,
                              ...
                              child: Container(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    await showModalBottomSheet(
                                      isScrollControlled: true,
                                      backgroundColor: Color(0x74000000),
                                      enableDrag: false,
                                      context: context,
                                      builder: (context) {
                                        return GestureDetector(
                                      ...
                                      Container(
                                        ...
                                        child: Image.network(
                                          valueOrDefault<String>(
                                            ...
                                            'https://cdn-icons-png.freepik.com/512/5951/5951752.png',
                                          ),
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                    ...
                    child: Padding(
                      ...
                      child: FutureBuilder<List<RegistrosRow>>(
                        future: RegistrosTable().queryRows(
                          queryFn: (q) => q.eqOrNull(
                            'user_id',
                            telaCompletaUsuariosRow?.userId,
                          ),
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                                  ...
                                  child: FutureBuilder<List<ViewSaldofinalRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<ViewSaldofinalRow>
                                          totalsViewSaldofinalRowList =
                                          snapshot.data!;

                                      final totalsViewSaldofinalRow =
                                          totalsViewSaldofinalRowList.isNotEmpty
                                              ? totalsViewSaldofinalRowList
                                                  .first
                                              : null;
